...
const traverseThroughArray = (array,idTag)=>{let outputString = '<table><tr><th>Index</th><th>Element of an array</th></tr>';
    array.map((element,id)=>outputString += `<tr><td>${id}   -</td> <td>${element}</td></tr> `)
    outputString +="</table>"
    console.log(outputString)
    document.getElementById(idTag).innerHTML = outputString}
